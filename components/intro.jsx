...
const EnhancedVideoPlayer = () => {
  ...
  return (
    ...
    <div className="min-h-screen relative flex flex-col items-center justify-center p-8">
      ...
      <motion.button 
        className="mt-8 px-8 py-4 bg-indigo-800  text-white font-semibold rounded-full shadow-lg transition duration-300 ease-in-out transform hover:bg-indigo-900"
        variants={buttonVariants}
        initial="hidden"
        animate={controls}
        whileHover="hover"
